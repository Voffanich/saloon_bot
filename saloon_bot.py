...
def start(m, res=False):    
    ...
    client_list.append(m.from_user.username)
    print()
...
@bot.message_handler(func=lambda _: db.flag == 'изменить телефон')
def change_phone_number(message):
    bot.send_message(message.chat.id, text=f'Ля ты молодец!')
    db.flag = ''
