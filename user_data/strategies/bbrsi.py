...
class BBRSI(IStrategy):
    ...
    buy_bb = CategoricalParameter(["bb_l1","bb_l2", "bb_l3"], default="bb_l2", space='buy', optimize=True, load=True)
    sell_bb = CategoricalParameter(["bb_m1", "bb_l1", "bb_u1"], default='bb_m1', space='sell', optimize=True, load=True)
    """
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['bb_m2'] = bollinger2['mid']
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (dataframe['rsi'] > 42) &
                (dataframe["close"] < dataframe["bb_l3"])
            ),
            'buy'] = 1
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (dataframe["close"] > dataframe["bb_m1"]) &
                (dataframe['rsi'] > 72)
            ),
            'sell'] = 1
        return dataframe
